"""Odysseus models ported to Amunty."""
...
class Document(TimestampMixin, Base):
    ...
    session_id      = Column(String, ForeignKey("conversations.id", ondelete="SET NULL"), nullable=True, index=True)
    ...
    session  = relationship("Conversation", backref=backref("documents", cascade="save-update, merge"))
...
class CrewMember(TimestampMixin, Base):
    ...
    session = relationship("Conversation", foreign_keys=[session_id],
...
class ScheduledTask(TimestampMixin, Base):
    ...
    session = relationship("Conversation", backref=backref("scheduled_tasks", cascade="save-update, merge"))
