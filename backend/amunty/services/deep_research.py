...
from amunty.services.research_utils import strip_thinking, is_low_quality

from amunty.services.goal_based_extractor import EXTRACTOR_PROMPT
...
class DeepResearcher:
    ...
    async def _search(self, query: str) -> List[Dict]:
        ...
        try:
            from amunty.services.search.providers import _get_search_settings
            from amunty.services.search.core import _call_provider, _build_provider_chain
